...
@dataclass
class StopScheduleRequest(BaseEntityRequest):
    """
    Request class for StopSchedule entities.

    Attributes
    ----------
    from_datetime : datetime, optional
        The starting datetime for fetching stop schedules (default is current datetime).
    duration : int, optional
        The duration in seconds for which to fetch stop schedules (default is 86400 seconds).
    depth : int, optional
    ...
    direction_type : str, optional
        The direction type of the stop schedules to fetch, e.g., "all", "forward", "backward" (default is "all").
    """
    ...
    def to_filters(self) -> Dict[str, Any]:
        """
        Converts the StopScheduleRequest instance into a dictionary of filters.
