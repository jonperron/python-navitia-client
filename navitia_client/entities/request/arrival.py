...
@dataclass
class ArrivalRequest(BaseEntityRequest):
    """
    Request class for Arrival entities.
    ...
    def to_filters(self) -> Dict[str, Any]:
        """
        Converts the ArrivalRequest instance into a dictionary of filters.

        Returns:
            Dict[str, Any]: A dictionary representation of the request filters.
        """
        filters = {
