...
@dataclass
class TerminusScheduleRequest(BaseEntityRequest):
    """
    Request class for TerminusSchedule entities.

    Attributes
    ----------
    from_datetime : datetime, optional
        The starting datetime for fetching terminus schedules (default is current datetime).
    duration : int, optional
        The duration in seconds for which to fetch terminus schedules (default is 86400 seconds).
    depth : int, optional
    ...
    direction_type : str, optional
        The direction type of the terminus schedules to fetch, e.g., "all", "forward", "backward" (default is "all").
    """
    ...
    def to_filters(self) -> Dict[str, Any]:
        """
        Converts the TerminusScheduleRequest instance into a dictionary of filters.
