...
class RouteApiClient(ApiBaseClient, EntityApi[Route]):
    ...
    Methods
    -------
    _get_entity_from_response(raw_entity_response: Any) -> Collection[Route]:
    ...
    ) -> Tuple[Collection[Route], Pagination]:
    ...
    @staticmethod
    def _get_entity_from_response(raw_entity_response: Any) -> Collection[Route]:
        """
        Static method to extract Route instances from the raw API response.
