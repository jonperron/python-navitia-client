...
class PhysicalModeApiClient(ApiBaseClient, EntityApi[PhysicalMode]):
    ...
    Methods
    -------
    _get_entity_from_response(raw_entity_response: Any) -> Collection[PhysicalMode]:
    ...
    ) -> Tuple[Collection[PhysicalMode], Pagination]:
    ...
    @staticmethod
    def _get_entity_from_response(raw_entity_response: Any) -> Collection[PhysicalMode]:
        """
        Static method to extract PhysicalMode instances from the raw API response.
