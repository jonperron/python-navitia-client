...
class CompanyApiClient(ApiBaseClient, EntityApi[Company]):
    ...
    Methods
    -------
    _get_entity_from_response(raw_entity_response: Any) -> Collection[Company]:
    ...
    ) -> Tuple[Collection[Company], Pagination]:
    ...
    @staticmethod
    def _get_entity_from_response(raw_entity_response: Any) -> Collection[Company]:
        """
        Static method to extract Company entities from the raw API response.
