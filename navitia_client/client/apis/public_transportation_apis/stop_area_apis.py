...
class StopAreaApiClient(ApiBaseClient, EntityApi[StopArea]):
    ...
    Methods
    -------
    _get_entity_from_response(raw_entity_response: Any) -> Collection[StopArea]:
    ...
    ) -> Tuple[Collection[StopArea], Pagination]:
    ...
    @staticmethod
    def _get_entity_from_response(raw_entity_response: Any) -> Collection[StopArea]:
        """
        Static method to extract StopArea instances from the raw API response.
