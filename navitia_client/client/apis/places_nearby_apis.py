...
class PlacesNearbyApiClient(ApiBaseClient):
    ...
    def _get_places_nearby(
        ...
        Returns:
            Tuple[Collection[Place], Pagination]: A tuple containing a list of nearby Place objects
    ...
    def list_objects_by_region_id_and_path(
        ...
        distance: int = 500,
        type: Collection[str] = ["stop_area", "stop_point", "poi"],
        admin_uri: Optional[Collection[str]] = None,
        ...
        Parameters:
            ...
            admin_uri (Optional[Collection[str]], optional): The administrative URIs to filter by.
                Defaults to None.
            ...
            add_poi_infos (Collection[str], optional): Additional POI information to include.
