...
def test_list_covered_areas_with_region_id(
    ...
    # When
    journeys = journeys_apis.list_journeys_with_region_id(
        region_id="bar", request=JourneyRequest()
    )
...
def test_list_covered_areas_with_resource_path(
    ...
    # When
    journeys = journeys_apis.list_journeys_with_resource_path(
        resource_path="bar", request=JourneyRequest()
    )
...
def test_list_covered_areas(
    ...
    # When
    request = JourneyRequest(from_="foo")
    journeys = journeys_apis.list_journeys(request=request)
